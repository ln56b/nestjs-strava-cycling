...
export class InitialMigration1753708807416 implements MigrationInterface {
  name = 'InitialMigration1753708807416';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "gear" ("uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "id" character varying NOT NULL, "primary" boolean NOT NULL, "name" character varying NOT NULL, "distance" integer NOT NULL, "brand" character varying, "model" character varying, "athleteId" character varying NOT NULL, CONSTRAINT "UQ_f57e90b5a9b1363699e02ffe30c" UNIQUE ("id"), CONSTRAINT "PK_ebe190408d14a6a99ab19b56a12" PRIMARY KEY ("uuid"))`,
    );
    await queryRunner.query(
